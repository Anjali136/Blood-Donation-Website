...
<head>
    ...
    <link rel="stylesheet" href="common_concernNEW.css">
</head>
    <body> 
    <div id="header">
     ...
     <a href="log1.php " class="top">Looking for blood</a>
        ...
        <div class="menu">
    <h1 class="c">Common Concerns
    </h1>
    
    
            <h2 class="t"> 1.Take Pride</h2>
            <h3 class="h3">
                Try to focus on the good you are doing - your blood donation can help save more than one life. </h3>
       
            <h2 class="t">2. Be Prepared </h2>
            <h3 class="h3">Before your appointment, read up on the donation process so you know what to expect at every step.</h3>
      
            <h2 class="t">3. Relax</h2>
            <h3 class="h3">Listen to music, read a book, talk to our staff, or simply close your eyes and rest for a few minutes.
            </h3>
       
    
            <h2 class="t">4. Good Health</h2>
            <h3 class="h3">You generally feel well, even if you're being treated for a chronic condition. Learn about health and wellness.</h3>
       
            <h2 class="t">5. Age 17</h2>
        <h3 class="h3">16 year olds may donate with parental permission in certain states if allowed by state law.</h3>
  
    
            <h2 class="t">6. All Types</h2>
            <h3 class="h3">Whether you’re A, B, AB or O – or unknown – all types of blood are valuable and can help save lives.</h3>
